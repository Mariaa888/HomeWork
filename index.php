...
<body>
    <nav>
        ...
        <ul class="navscreeen">
            ...
            <li><a href="php/proudect.php" class="active">prodect</a></li>
            <li><a href="#">shop</a></li>
            <li><a href="#">contact</a></li>
            <li>
                <?php
                if (!isset($_SESSION['username'])) {
                ?><a href="php/login.php">Login</a> </li>
        <?php } else { ?> <li><?php
            ...
            <li><a href="php/logout.php">LogOut</a><?php } ?>
    ...
    <div class="background">
        <div class="right">
            ...
            <div class="shopnowbut">
                <button class="shopnow"><a href="php/proudect.php">Shop Now</button></a>
            </div>
    ...
    <div class="category">
        ...
        <div class="cat"><a href="php/bed.php">
                <img src="image/bed3.jpeg" alt="" class="img">
                <p>Bed</p>
            </a>
        </div>

        <div class="cat"><a href="php/chair.php">
                <img src="image/chair1.webp" alt="" class="img">
                <p>Chairs</p>
            </a>
        </div>
        <div class="cat"><a href="php/table.php">
