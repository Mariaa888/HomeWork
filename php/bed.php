...
<body>
    <div class="contain">
        <nav>
            ...
            <ul class="navbar">
                <li onclick="closebar()"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <div class="cartTab">
        ...
        <div class="btn">
            ...
            <button class="checkOut" <?php
                                        if (isset($_SESSION['username'])) {
                                        ?> onclick="handleCheckout()" <?php
                                        } elseif (!isset($_SESSION['username'])) {
                                            ?> onclick="    window.location.href = 'login.php';" <?php
                                                                }
                                                                    ?>>Check Out</button>
